...
from maascommon.enums.ipmi import IPMIPriviledgeLevel
...
IPMI_PRIVILEGE_LEVEL_CHOICES = [
    [IPMIPriviledgeLevel.USER.name, "User"],
    [IPMIPriviledgeLevel.OPERATOR.name, "Operator"],
    [IPMIPriviledgeLevel.ADMIN.name, "Administrator"],
]
...
class IPMIPowerDriver(PowerDriver):
    ...
    settings = [
        ...
        make_setting_field(
            ...
            default=IPMIPriviledgeLevel.OPERATOR.name,
        ),
        make_setting_field(
            "workaround_flags",
            "Workaround Flags",
    ...
    def _issue_ipmi_command(
        ...
        **extra,
        ...
        if is_power_parameter_set(privilege_level):
            ...
            common_args.extend(("-l", IPMIPriviledgeLevel.OPERATOR.name))
