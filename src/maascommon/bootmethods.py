...
class IPXEBootMetadata(BootMetadata):
...
class PXEBootMetadata(BootMetadata):
    path_prefix_http = True
...
class UefiAmd64BootMetadata(BootMetadata):
...
class PowerNvBootMetadata(BootMetadata):
    path_prefix = "ppc64el/"
...
class S390XBootMetadata(BootMetadata):
    path_prefix = "s390x/"
...
class S390XPartitionBootMetadata(BootMetadata):
    @property
    def name(self) -> str:
...
class WindowsPXEBootMetadata(BootMetadata):
    @property
    def name(self) -> str:
        return "windows"
