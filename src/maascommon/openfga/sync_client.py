...
class SyncOpenFGAClient(BaseOpenFGAClient):
    ...
    def _list_objects(self, user, relation: str, obj_type: str) -> list[str]:
        response = self.client.post(
