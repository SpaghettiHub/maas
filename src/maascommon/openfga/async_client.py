...
class OpenFGAClient(BaseOpenFGAClient):
    ...
    async def can_edit_machines_in_pool(self, user_id: str, pool_id: int):
        return await self._check(
            user_id, "can_edit_machines", self._format_pool(pool_id)
        )

    async def can_deploy_machines_in_pool(self, user_id: str, pool_id: int):
        return await self._check(
            user_id, "can_deploy_machines", self._format_pool(pool_id)
        )

    async def can_view_machines_in_pool(self, user_id: str, pool_id: int):
        return await self._check(
    ...
    # Global Permissions
    async def can_edit_global_entities(self, user_id: str):
        return await self._check(
    ...
    async def can_edit_controllers(self, user_id: str):
        return await self._check(
    ...
    async def can_edit_permissions(self, user_id: str):
        return await self._check(
            user_id, "can_edit_permissions", self.MAAS_GLOBAL_OBJ
        )

    async def can_view_permissions(self, user_id: str):
        return await self._check(
            user_id, "can_view_permissions", self.MAAS_GLOBAL_OBJ
        )

    async def can_edit_configurations(self, user_id: str):
        return await self._check(
    ...
    async def can_edit_notifications(self, user_id: str):
        return await self._check(
    ...
    async def can_edit_boot_entities(self, user_id: str):
        return await self._check(
            user_id, "can_edit_boot_entities", self.MAAS_GLOBAL_OBJ
        )

    async def can_view_boot_entities(self, user_id: str):
        return await self._check(
            user_id, "can_view_boot_entities", self.MAAS_GLOBAL_OBJ
        )

    async def can_edit_license_keys(self, user_id: str):
        return await self._check(
            user_id, "can_edit_license_keys", self.MAAS_GLOBAL_OBJ
        )

    async def can_view_license_keys(self, user_id: str):
        return await self._check(
    ...
    # List Methods
    async def list_pools_with_view_machines_access(self, user_id: str):
    ...
    async def list_pool_with_deploy_machines_access(self, user_id: str):
        return await self._list_objects(user_id, "can_deploy_machines", "pool")

    async def list_pools_with_edit_machines_access(self, user_id: str):
