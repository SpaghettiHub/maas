...
Each custom operating system has unique prerequisites:

| Desired image | Host OS       | Features     | Dependencies      | Template |
|---------------|---------------|--------------|-------------------|----------|
| centos7       | Ubuntu 18.04+ | Can run KVMs | qemu-utils        |          |
|               |               |              | packer            |          |
|               |               |              | MAAS 2.3+         |          |
|               |               |              | Curtin 18.1-59+   |          |
|---------------|---------------|--------------|-------------------|----------|
| centos8       | Ubuntu 18.04+ | Can run kvms | qemu-utils        |          |
|               |               |              | packer            |          |
|               |               |              | RHEL 8 DVD ISO    |          |
|               |               |              | MAAS 2.3+         |          |
|               |               |              | Curtin 18.1-59+   |          |
|---------------|---------------|--------------|-------------------|----------|
| rhel7         | Ubuntu 18.04+ | Can run kvms | qemu-utils        |          |
|               |               |              | packer            |          |
|               |               |              | RHEL 7 DVD ISO    |          |
|               |               |              | MAAS 2.3+         |          |
|               |               |              | Curtin 18.1-59+   |          |
|---------------|---------------|--------------|-------------------|----------|
| rhel8         | Ubuntu 18.04+ | Can run kvms | qemu-utils        |          |
|               |               |              | packer            |          |
|               |               |              | RHEL 8 DVD ISO    |          |
|               |               |              | MAAS 2.3+         |          |
|               |               |              | Curtin 18.1-59+   |          |
|---------------|---------------|--------------|-------------------|----------|
| Ubuntu        | Ubuntu 18.04+ | Can run KVMs | qemu-utils        |          |
|               |               |              | qemu-system       |          |
|               |               |              | ovmf              |          |
|               |               |              | cloud-image-utils |          |
|---------------|---------------|--------------|-------------------|----------|
