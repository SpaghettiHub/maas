...
class TestTriggersUsed(MAASServerTestCase):
    ...
    triggers_system = {
        ...
        "dnsresource_sys_dns_updates_maasserver_dnsresource_update",
        "dnsresource_sys_dns_updates_maasserver_dnsresource_delete",
        "dnsresource_ip_addresses_sys_dns_updates_dns_ip_insert",
        "dnsresource_ip_addresses_sys_dns_updates_dns_ip_delete",
        "domain_sys_dns_domain_delete",
        "domain_sys_dns_domain_insert",
        "domain_sys_dns_domain_update",
        "domain_sys_dns_updates_maasserver_domain_delete",
        "domain_sys_dns_updates_maasserver_domain_insert",
