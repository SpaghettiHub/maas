    ...
    def connectionMade(self):
        ...
        def trust_connection(authenticated: bool):
            if authenticated:
                ...
                log.info(f"Connection {self.connid} is NOT trusted.")
            # If the authentication process is successful, we allow to execute rpc calls from now on on the commands that require
            # authentication
