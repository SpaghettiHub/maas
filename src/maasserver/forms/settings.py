...
def make_maas_proxy_port_field(*args, **kwargs):
    ...
    return forms.IntegerField(
        validators=[MAASProxyPortConfig.validate_port], **kwargs
    )
...
def make_maas_syslog_port_field(*args, **kwargs):
    ...
    return forms.IntegerField(
        validators=[MAASSyslogPortConfig.validate_port], **kwargs
    )
...
CONFIG_ITEMS = {
    ...
    DNSSECValidationConfig.name: {
        "default": DNSSECValidationConfig.default.value,
    ...
    NetworkDiscoveryConfig.name: {
        "default": NetworkDiscoveryConfig.default.value,
    ...
    ActiveDiscoveryIntervalConfig.name: {
        "default": ActiveDiscoveryIntervalConfig.default.value,
    ...
    DefaultBootInterfaceLinkTypeConfig.name: {
        "default": DefaultBootInterfaceLinkTypeConfig.default.value,
    ...
    DefaultStorageLayoutConfig.name: {
        "default": DefaultStorageLayoutConfig.default.value,
        "form": forms.ChoiceField,
        "form_kwargs": {
    ...
    MAASAutoIPMIUserPrivilegeLevelConfig.name: {
        "default": MAASAutoIPMIUserPrivilegeLevelConfig.default.value,
        "form": forms.ChoiceField,
        "form_kwargs": {
    ...
    MAASAutoIPMICipherSuiteIDConfig.name: {
        "default": MAASAutoIPMICipherSuiteIDConfig.default.value,
        "form": forms.ChoiceField,
        "form_kwargs": {
