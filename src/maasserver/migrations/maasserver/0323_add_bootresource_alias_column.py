...
def populate_ubuntu_alias(apps, schema_editor):
    """Migrate all the existing Ubuntu BootResources trying to convert the codename to the version"""
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(populate_ubuntu_alias),
