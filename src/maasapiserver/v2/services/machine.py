...
from maascommon.enums.interface import InterfaceTypeEnum
    ...
    def _single_query(self, ids):
        ...
        extra_macs_cte = (
            ...
            .where(
                ...
                InterfaceTable.c.type == InterfaceTypeEnum.PHYSICAL,
            )
            .group_by(NodeTable.c.id)
        ).cte("extra_macs")
        ...
        dhcp_address_cte = (
            ...
            .where(
                StaticIPAddressTable.c.alloc_type == IpAddressTypeEnum.DHCP,
                DiscoveredAddress.c.alloc_type == IpAddressTypeEnum.DISCOVERED,
        ...
        interface_addresses_cte = (
            ...
            .where(
                ...
                StaticIPAddressTable.c.alloc_type.in_(
                    (
                        IpAddressTypeEnum.DHCP,
                        IpAddressTypeEnum.AUTO,
                        IpAddressTypeEnum.STICKY,
                        IpAddressTypeEnum.USER_RESERVED,
                    )
                ),
            )
        ...
        stmt = (
            select(
                ...
                case(
                    (
                        BMCTable.c.bmc_type == BmcTypeEnum.POD,
                        BMCTable.c.id,
                    ),
                    else_=None,
                ).label("pod_id"),
