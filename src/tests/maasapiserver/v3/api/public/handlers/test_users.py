...
class TestUsersApi(ApiCommonTests):
    ...
    async def test_create_user_409(
        self,
        services_mock: ServiceCollectionV3,
        mocked_api_client_admin: AsyncClient,
    ) -> None:
    ...
    async def test_create_user_422(
        self,
        services_mock: ServiceCollectionV3,
        mocked_api_client_admin: AsyncClient,
    ...
    async def test_update_users(
        ...
        services_mock.users = Mock(UsersService)
        services_mock.users.update.return_value = updated_user
    ...
    async def test_update_users_404(
        self,
        services_mock: ServiceCollectionV3,
        mocked_api_client_admin: AsyncClient,
    ) -> None:
        services_mock.users = Mock(UsersService)
        services_mock.users.update.return_value = None
    ...
    async def test_update_users_422(
        self,
        services_mock: ServiceCollectionV3,
        mocked_api_client_admin: AsyncClient,
    ) -> None:
