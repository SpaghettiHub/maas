...
from maascommon.enums.ipmi import IPMICipherSuiteID, IPMIPriviledgeLevel
...
class MAASAutoIPMIUserPrivilegeLevelConfig(
    Config[Optional[IPMIPriviledgeLevel]]
):
    name: ClassVar[str] = "maas_auto_ipmi_user_privilege_level"
    default: ClassVar[Optional[IPMIPriviledgeLevel]] = (
        IPMIPriviledgeLevel.ADMIN
    )
    ...
    value: Optional[IPMIPriviledgeLevel] = Field(
        default=default, description=description
    )
