...
from sqlalchemy import delete, eq, insert, select
...
class DNSResourceResourceBuilder(CreateOrUpdateResourceBuilder):
    def with_name(self, value: str) -> "DNSResourceResourceBuilder":
        self._request.set_value(DNSResourceTable.c.name, value)
        return self

    def with_domain_id(self, value: id) -> "DNSResourceResourceBuilder":
        self._request.set_value(DNSResourceTable.c.domain_id, value)
        return self
